...
gnome-terminal --title="Load Balancer" -e "bash -c 'java -cp ./jars/json-20180813.jar:./jars/mysql-connector-java-8.0.15.jar:./ LoadBalancer RR'" 1>/dev/null 
echo "Starting Client process..."
gnome-terminal --title="Client1" -e "bash -c 'java -cp ./jars/json-20180813.jar:./jars/mysql-connector-java-8.0.15.jar:./ Client'" 1>/dev/null
echo "All processes running."
#gnome-terminal --title="Client2" -e "bash -c 'java -cp ./jars/json-20180813.jar:./jars/mysql-connector-java-8.0.15.jar:./ Client'" 1>/dev/null
#gnome-terminal --title="Client3" -e "bash -c 'java -cp ./jars/json-20180813.jar:./jars/mysql-connector-java-8.0.15.jar:./ Client'" 1>/dev/null
